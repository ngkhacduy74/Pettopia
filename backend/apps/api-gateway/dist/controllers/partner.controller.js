...
let PartnerController = class PartnerController {
    ...
    async inviteClinicMember(invited_email, role, clinic_id, invited_by) {
        ...
        return await (0, rxjs_1.lastValueFrom)(this.partnerService.send({ cmd: 'createClinicMemberInvitation' }, { clinic_id, invited_email, role, invited_by }));
    }
    ...
    async declineClinicInvitationPublic(token) {
    ...
    async getClinicMembers(clinicId, page = 1, limit = 10) {
        if (!clinicId)
            throw new common_1.BadRequestException('Thiếu thông tin phòng khám');
        return await (0, rxjs_1.lastValueFrom)(this.partnerService.send({ cmd: 'getClinicMembers' }, { clinic_id: clinicId, page, limit }));
    }
    async getClinicMembersByAdmin(clinicId, page = 1, limit = 10) {
        if (!clinicId)
            throw new common_1.BadRequestException('Thiếu thông tin phòng khám');
        return await (0, rxjs_1.lastValueFrom)(this.partnerService.send({ cmd: 'getClinicMembers' }, { clinic_id: clinicId, page, limit }));
    }
    async removeClinicMember(memberId, clinicId) {
        if (!memberId || !clinicId)
            throw new common_1.BadRequestException('Thiếu thông tin bắt buộc');
        return await (0, rxjs_1.lastValueFrom)(this.partnerService.send({ cmd: 'removeMemberFromClinic' }, { clinicId, memberId }));
    }
    async updateMyClinicInfo(clinic_id, updateData) {
    ...
    async findAllClinic(page = 1, limit = 10, userRole) {
    ...
    async getVetById(id, roles, clinic_id) {
        return await (0, rxjs_1.lastValueFrom)(this.partnerService.send({ cmd: 'getVetById' }, { roles, clinic_id, vet_id: id }));
    }
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], PartnerController.prototype, "declineClinicInvitationPublic", null);
__decorate([
    (0, common_1.UseGuards)(jwtAuth_guard_1.JwtAuthGuard, role_guard_1.RoleGuard),
    (0, roles_decorator_1.Roles)(roles_decorator_1.Role.VET),
    (0, common_1.Post)('/clinic/invitations/:token/decline-auth'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    __param(0, (0, common_1.Param)('token')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
...
__decorate([
    (0, common_1.UseGuards)(jwtAuth_guard_1.JwtAuthGuard, role_guard_1.RoleGuard),
    (0, roles_decorator_1.Roles)(roles_decorator_1.Role.CLINIC),
    (0, common_1.Get)('/clinic/members/vets'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
...
__decorate([
    (0, common_1.UseGuards)(jwtAuth_guard_1.JwtAuthGuard, role_guard_1.RoleGuard),
    (0, roles_decorator_1.Roles)(roles_decorator_1.Role.ADMIN, roles_decorator_1.Role.STAFF),
    (0, common_1.Get)('/clinic/:clinic_id/members/vets'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    __param(0, (0, common_1.Param)('clinic_id')),
    __param(1, (0, common_1.Query)('page', new common_1.ParseIntPipe({ optional: true }))),
    __param(2, (0, common_1.Query)('limit', new common_1.ParseIntPipe({ optional: true }))),
    ...
    __metadata("design:paramtypes", [String, Object, Object]),
    __metadata("design:returntype", Promise)
], PartnerController.prototype, "getClinicMembersByAdmin", null);
__decorate([
    (0, common_1.UseGuards)(jwtAuth_guard_1.JwtAuthGuard, role_guard_1.RoleGuard),
    (0, roles_decorator_1.Roles)(roles_decorator_1.Role.CLINIC),
    (0, common_1.Delete)('/clinic/members/:memberId'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    ...
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", Promise)
], PartnerController.prototype, "removeClinicMember", null);
__decorate([
    (0, common_1.Patch)('/clinic/me'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, common_1.UseGuards)(jwtAuth_guard_1.JwtAuthGuard, role_guard_1.RoleGuard),
    (0, roles_decorator_1.Roles)(roles_decorator_1.Role.CLINIC),
    ...
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], PartnerController.prototype, "updateMyClinicInfo", null);
__decorate([
...
__decorate([
    ...
    (0, common_1.UseGuards)(jwtAuth_guard_1.JwtAuthGuard, role_guard_1.RoleGuard),
    (0, roles_decorator_1.Roles)(roles_decorator_1.Role.ADMIN, roles_decorator_1.Role.STAFF, roles_decorator_1.Role.USER),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    __param(0, (0, common_1.Query)('page', new common_1.ParseIntPipe({ optional: true }))),
    __param(1, (0, common_1.Query)('limit', new common_1.ParseIntPipe({ optional: true }))),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], PartnerController.prototype, "getVetById", null);
__decorate([
    (0, common_1.UseGuards)(jwtAuth_guard_1.JwtAuthGuard, role_guard_1.RoleGuard),
    (0, roles_decorator_1.Roles)(roles_decorator_1.Role.CLINIC),
